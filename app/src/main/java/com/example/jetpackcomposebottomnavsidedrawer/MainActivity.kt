package com.example.jetpackcomposebottomnavsidedrawer
...
import com.example.jetpackcomposebottomnavsidedrawer.components.dialog.LogoutDialog
        ...
        var topBar: @Composable () -> Unit = {
	        CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
		        TopBar(
			        ...
			        sideNavIcon = painterResource(id = R.drawable.menu_three),
